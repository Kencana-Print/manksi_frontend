...
const fetchData = async () => {
  ...
  try {
    const res = await spkGudangFormService.searchJenisKainKaosan(
      search.value,
      currentPage.value,
      perPage.value,
    );
    ...
    console.error("Gagal memuat Jenis Kain Kaosan:", e);
  } finally {
  ...
  >
    <div class="lookup-card">
      <div class="lookup-header">
        ...
        <span>Cari Jenis Kain Kaosan</span>
        <v-spacer />
      ...
      <div class="lookup-search">
        ...
        <input
          ...
          type="text"
          placeholder="Cari kode atau nama jenis kain..."
          class="search-input"
          autofocus
        />
