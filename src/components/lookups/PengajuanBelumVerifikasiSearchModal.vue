...
import { verifikasiPengajuanFormService } from "@/services/piutang/verifikasiPengajuanFormService";
...
const fetchData = async () => {
  ...
  try {
    const res = await verifikasiPengajuanFormService.searchPengajuan(
      search.value,
      currentPage.value,
      perPage.value,
    );
  ...
  >
    <div class="lookup-card">
      <div class="lookup-header">
        ...
        <span>Cari Nomor Pengajuan</span>
        <span class="lookup-header-sub">belum diverifikasi</span>
        <v-spacer />
      ...
      <div class="lookup-search">
        ...
        <input
          ...
          type="text"
          placeholder="Cari nomor, keterangan, atau nama..."
          class="search-input"
          autofocus
        />
