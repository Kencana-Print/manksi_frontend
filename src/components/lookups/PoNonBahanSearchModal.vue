...
const fetchData = async () => {
  ...
  try {
    // UBAH URL DI SINI MENJADI po-garmen-buka
    const res = await api.get("/lookups/po-garmen-buka", {
      params: {
        q: search.value,
        jenis: props.jenis,
    ...
    console.error("Gagal memuat PO Terbuka:", e);
  } finally {
  ...
  >
    <div class="lookup-card">
      <div class="lookup-header">
        ...
        <span>Cari PO Terbuka ({{ props.jenis }})</span>
        <v-spacer />
        <button
          type="button"
          class="lookup-close"
      ...
      <div class="lookup-search">
        ...
        <input
          ...
          type="text"
          placeholder="Cari Nomor PO atau Keterangan..."
          class="search-input"
          autofocus
        />
        <button
