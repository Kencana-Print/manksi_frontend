...
const fetchData = async () => {
  ...
  try {
    const res = await pengajuanDanaFormService.searchJobButuh(
      search.value,
      currentPage.value,
      perPage.value,
    );
    ...
    console.error("Gagal memuat Job Butuh:", e);
  } finally {
...
const selectItem = async (item: any) => {
  try {
    const res = await pengajuanDanaFormService.getJobButuhDtl(item.Nomor);
    emit("selected", { job: item, items: res.data.data || [] });
    emit("update:modelValue", false);
  } catch (e: any) {
    toast.warning(e.response?.data?.message || "Gagal memuat detail job.");
  }
};
</script>
  ...
  >
    <div class="lookup-card">
      <div class="lookup-header">
        ...
        <span>Import dari Job Butuh (Supervisor)</span>
        <v-spacer />
      ...
      <div class="lookup-search">
        ...
        <input
          ...
          type="text"
          placeholder="Cari nomor, spv, atau keterangan..."
          class="search-input"
          autofocus
        />
