  ...
  >
    <div class="lookup-card">
      <div class="lookup-header">
        ...
        >
        <span>Pilih Referensi MAP / SPK</span>
        <v-spacer />
      ...
      <div class="lookup-search">
        ...
        <input
          v-model="search"
          type="text"
          placeholder="Cari berdasarkan nomor atau nama pekerjaan..."
          class="search-input"
          autofocus
        />
      ...
      <div class="lookup-table-wrap">
        ...
        <table v-else class="lookup-table">
          ...
          <tbody>
            ...
            >
              <td class="td-kode">{{ item.mspk_nomor || item.Nomor }}</td>
              <td>{{ item.mspk_tanggal || item.Tanggal }}</td>
              <td>{{ item.mspk_nama || item.Nama }}</td>
            </tr>
          </tbody>
        </table>
      </div>
...
<style scoped>
/* Gunakan style CSS yang sama dengan referensi */
.lookup-card {
  background: white;
  border-radius: 8px;
  overflow: hidden;
