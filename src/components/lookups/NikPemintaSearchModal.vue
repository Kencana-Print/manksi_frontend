...
import { IconUserSearch, IconSearch, IconDatabaseOff } from "@tabler/icons-vue";

const props = defineProps<{ modelValue: boolean; lokasi?: string }>();
...
const fetchData = async () => {
  ...
  try {
    const res = await pengajuanDanaFormService.searchNik(
      search.value,
      props.lokasi,
      currentPage.value,
      perPage.value,
    ...
    console.error("Gagal memuat NIK:", e);
  } finally {
  ...
  >
    <div class="lookup-card">
      <div class="lookup-header">
        <IconUserSearch :size="15" :stroke-width="1.7" color="white" />
        <span>Cari NIK Peminta</span>
        <v-spacer />
