...
import { IconReceiptTax, IconSearch, IconDatabaseOff } from "@tabler/icons-vue";
...
const fetchData = async () => {
  ...
  try {
    const res = await svc.searchInvoice(
      search.value,
      currentPage.value,
      perPage.value,
    );
  ...
  >
    <div class="lookup-card">
      <div class="lookup-header">
        <IconReceiptTax :size="15" :stroke-width="1.7" color="white" />
        <span>Cari Invoice (ber-PPN)</span>
        <v-spacer />
