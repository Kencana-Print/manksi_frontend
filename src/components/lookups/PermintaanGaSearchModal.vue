...
const fetchData = async () => {
  ...
  try {
    const res = await pengajuanDanaFormService.searchPermintaanPjh(
      search.value,
      currentPage.value,
      perPage.value,
    );
    ...
    console.error("Gagal memuat Permintaan:", e);
  } finally {
  ...
  >
    <div class="lookup-card">
      <div class="lookup-header">
        ...
        <span>Import dari Permintaan GA</span>
        <span class="lookup-header-sub">belum ke-beli penuh</span>
        <v-spacer />
      ...
      <div class="lookup-search">
        ...
        <input
          ...
          type="text"
          placeholder="Cari nomor pengajuan atau keterangan..."
          class="search-input"
          autofocus
        />
      ...
      <div class="lookup-table-wrap">
        ...
        <table v-else class="lookup-table">
          ...
          <tbody>
            ...
            >
              <td class="td-kode">{{ item.PjhNomor }}</td>
