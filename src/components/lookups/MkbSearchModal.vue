...
const fetchData = async () => {
  ...
  try {
    const res = await api.get("/lookups/mkb", {
      params: {
        q: search.value,
    ...
    console.error("Gagal memuat MKB:", e);
  } finally {
  ...
  >
    <div class="lookup-card">
      <div class="lookup-header">
        ...
        <span>Cari MKB (Memo Kebutuhan Bahan)</span>
        <v-spacer />
      ...
      <div class="lookup-search">
        ...
        <input
          ...
          type="text"
          placeholder="Cari nomor MKB, No. SPK, atau Nama SPK..."
          class="search-input"
          autofocus
        />
      ...
      <div class="lookup-table-wrap">
        ...
        <table v-else class="lookup-table">
          <thead>
            <tr>
              <th style="width: 140px">NOMOR MKB</th>
