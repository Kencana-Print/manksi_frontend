...
const fetchData = async () => {
  if (!props.jenis || !props.cabangTujuan) return;
  isLoading.value = true;
  try {
    const res = await api.get(
      "/garmen/barang/mutasi-out/form/search-permintaan-finance",
      {
        params: {
          jenis: props.jenis,
          cabangTujuan: props.cabangTujuan,
          search: search.value,
    ...
    // Asumsi response backend mengembalikan array, atau struktur data paginasi
    // Sesuaikan jika backend Anda me-return format .data.items & .data.total
    items.value = res.data.data.items || res.data.data;
    totalItems.value = res.data.data.total || res.data.data.length;
  } catch (e) {
    console.error("Gagal memuat permintaan kasbon:", e);
  } finally {
...
const selectItem = (item: any) => {
  emit("selected", item.NoPermintaan);
  ...
  >
    <div class="lookup-card">
      <div class="lookup-header">
        ...
        /></span>
        <span>Cari No Permintaan (Kasbon)</span>
        <v-spacer />
      ...
      <div class="lookup-search">
        ...
        <input
          ...
          type="text"
          placeholder="Cari Nomor Kasbon atau Keterangan..."
          class="search-input"
          autofocus
        />
      ...
      <div class="lookup-table-wrap">
        ...
        <table v-else class="lookup-table">
          <thead>
            <tr>
              <th style="width: 140px">NOMOR MINTA</th>
              <th style="width: 100px; text-align: center">TANGGAL</th>
              <th>KETERANGAN</th>
              <th style="width: 100px">PEMINTA</th>
            </tr>
          </thead>
          <tbody>
            <tr
            ...
            >
              <td class="td-kode">{{ item.NoPermintaan }}</td>
