...
const fetchData = async () => {
  ...
  try {
    ...
    console.error("Gagal memuat permintaan barang:", e);
  } finally {
    ...
    <div class="lookup-card">
      ...
      <div class="lookup-search">
        ...
        <input
          ...
          type="text"
          placeholder="Cari Nomor Minta, SPK, atau Keterangan..."
          class="search-input"
          autofocus
        />
      ...
      <div class="lookup-table-wrap">
        ...
        <table v-else class="lookup-table">
          <thead>
            <tr>
              <th style="width: 135px">NOMOR MINTA</th>
              <th style="width: 90px">TANGGAL</th>
              <th style="width: 140px" v-if="props.jenis === 'ACCESORIES'">
                SPK
              </th>
              <th v-if="props.jenis === 'ACCESORIES'">GUDANG PRODUKSI</th>
              <th>KETERANGAN</th>
              <th style="width: 80px">PEMINTA</th>
            </tr>
          </thead>
          <tbody>
            <tr
            ...
            >
              ...
              <td>{{ item.Tanggal }}</td>
              <td v-if="props.jenis === 'ACCESORIES'">{{ item.SPK }}</td>
              <td v-if="props.jenis === 'ACCESORIES'">
                {{ item.GudangProduksi }}
              </td>
