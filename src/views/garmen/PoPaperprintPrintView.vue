...
// ⚠️ Pola SAMA seperti SalesOrderPrintView: src langsung di-set ke
// kandidat pertama, kalau gagal load pindah ke kandidat berikutnya via
// @error — BUKAN pre-test pakai Image()/Promise (yang ternyata tidak
// reliable). Prioritas: 1) gambar upload khusus PO ini, 2) fallback
// gambar desain asli SPK dari VPS (map/ dulu, baru root, baru
// /file-gambar).
...
const loadData = async () => {
  ...
  try {
    const res = await poPaperprintService.getPrintData(nomor.value);
  ...
  <div class="print-page-wrap">
    ...
    <template v-else-if="data">
      ...
      <div class="print-sheet">
        ...
        <div class="doc-title">PO Paper Print</div>
        ...
        <table class="detail-table">
          <thead>
            <tr>
              ...
              <th style="min-width: 130px">Nama Desain</th>
