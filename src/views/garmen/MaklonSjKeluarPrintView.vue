...
onMounted(async () => {
  try {
    const res = await maklonBarangFormService.getSjKeluarPrintData(sjkNomor);
...
<template>
  ...
  <div v-else-if="isError" class="error-state">
    Gagal memuat data cetak SJ Maklon. Pastikan nomor benar.
  </div>
    ...
    <div class="print-container">
      ...
      <table class="info-table">
        <tr>
          ...
          <td class="sep">:</td>
          <td class="val">{{ data.header.sjk_mkl_nomor }}</td>
        </tr>
        <tr>
          <td class="lbl">No. Surat Jalan</td>
          <td class="sep">:</td>
          <td class="val">{{ data.header.sjk_nomor }}</td>
        </tr>
        <tr>
          <td class="lbl">Tanggal</td>
          <td class="sep">:</td>
          <td class="val">{{ tglIndo(data.header.sjk_tanggal) }}</td>
        </tr>
        <tr>
