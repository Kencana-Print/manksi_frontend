    ...
    <div class="print-page page-1">
                ...
                <td class="fv">
                  <template v-if="prosesChips.length">
                    <span
                      ...
                      :key="p"
                      class="proses-bg"
                      :class="p === 'DTF' ? 'bg-blue-light' : 'bg-green-light'"
                    >
                      {{ p }}
                    </span>
                  </template>
     ...
     MAP-nya sudah punya accessories/babaran diinput -->
        <div v-if="hasMkaFromMap" class="box mb-6">
          <div class="box-title">
            Kebutuhan Aksesoris &amp; Babaran (dari BAST MAP {{ spk.spk_memo }})
          </div>
     ...
     ada data dari BAST MAP -->
        ...
        <!-- Baris 5: Komponen Potong (kiri) + Second Process (kanan) -->
        <div class="p1-row-komp mb-6">
          <div class="box">
        ...
        <!-- Baris 6: Keterangan — special process kecil, produksi dominan -->
        <div class="p1-row-ket mb-6">
          <!-- Kiri: Special Process (kecil) + Gudang/Pembelian -->
          <div style="display: flex; flex-direction: column; gap: 6px">
            <div class="box">
              ...
              <div class="ket-list ket-small">
                ...
                <div v-if="keteranganKhusus.length === 0" class="muted">—</div>
              </div>
            </div>
            <div class="box">
              <div class="box-title">Keterangan gudang/pembelian</div>
              <pre class="ket-pre ket-small">{{ spk.spk_ketbeli || "—" }}</pre>
            </div>
          </div>

          <!-- Kanan: Keterangan Produksi (dominan) -->
          <div class="box">
