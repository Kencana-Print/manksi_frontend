...
// ── Image handling — sama pola dengan SalesOrderTabKatalog ──
...
// ── Fetch — reuse endpoint katalog SO yang sudah ada, customer-scoped ──
      ...
      <div v-if="selectedItem" class="side-body">
        ...
        <table class="side-table">
          <tbody>
            ...
            <tr>
              <td class="st-lbl">Bahan</td>
              <td class="st-val">{{ selectedItem.kain || "-" }}</td>
            </tr>
            <tr>
